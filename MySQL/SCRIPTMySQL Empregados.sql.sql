...
CREATE TABLE IF NOT EXISTS `empregados_db`.`empregado` (
  ...
  `sexo` CHAR(1) NULL,
  `dt_admissão` DATETIME NOT NULL,
  `est_civil` VARCHAR(45) NULL,
  `salario` DECIMAL(10,2) NOT NULL,
  PRIMARY KEY (`cod_empregado`),
  INDEX `fk_empregado_departamento_idx` (`cod_dept` ASC) INVISIBLE,
...
CREATE TABLE IF NOT EXISTS `empregados_db`.`dependentes` (
  ...
  INDEX `fk_dependentes_empregado1_idx` (`cod_empregado` ASC) VISIBLE,
